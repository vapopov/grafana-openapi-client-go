...
// WithXDisableProvenance adds the xDisableProvenance to the route delete alert rule params
func (o *RouteDeleteAlertRuleParams) WithXDisableProvenance(xDisableProvenance *string) *RouteDeleteAlertRuleParams {
	o.SetXDisableProvenance(xDisableProvenance)
	return o
}

// SetXDisableProvenance adds the xDisableProvenance to the route delete alert rule params
func (o *RouteDeleteAlertRuleParams) SetXDisableProvenance(xDisableProvenance *string) {
