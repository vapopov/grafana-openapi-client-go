...
// NewRoutePutTemplateParams creates a new RoutePutTemplateParams object,
...
func NewRoutePutTemplateParams() *RoutePutTemplateParams {
	return &RoutePutTemplateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewRoutePutTemplateParamsWithTimeout creates a new RoutePutTemplateParams object
...
// NewRoutePutTemplateParamsWithContext creates a new RoutePutTemplateParams object
...
// NewRoutePutTemplateParamsWithHTTPClient creates a new RoutePutTemplateParams object
...
// WithXDisableProvenance adds the xDisableProvenance to the route put template params
func (o *RoutePutTemplateParams) WithXDisableProvenance(xDisableProvenance *string) *RoutePutTemplateParams {
	o.SetXDisableProvenance(xDisableProvenance)
	return o
}

// SetXDisableProvenance adds the xDisableProvenance to the route put template params
func (o *RoutePutTemplateParams) SetXDisableProvenance(xDisableProvenance *string) {
