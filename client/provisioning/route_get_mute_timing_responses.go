...
func (o *RouteGetMuteTimingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/provisioning/mute-timings/{name}] RouteGetMuteTiming", response, response.Code())
	}
}
...
func (o *RouteGetMuteTimingOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/provisioning/mute-timings/{name}][%d] routeGetMuteTimingOk %s", 200, payload)
}
...
func (o *RouteGetMuteTimingNotFound) Error() string {
	return fmt.Sprintf("[GET /v1/provisioning/mute-timings/{name}][%d] routeGetMuteTimingNotFound", 404)
}
