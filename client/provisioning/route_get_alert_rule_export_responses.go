...
func (o *RouteGetAlertRuleExportReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/provisioning/alert-rules/{UID}/export] RouteGetAlertRuleExport", response, response.Code())
	}
}
...
func (o *RouteGetAlertRuleExportOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/provisioning/alert-rules/{UID}/export][%d] routeGetAlertRuleExportOk %s", 200, payload)
}
...
func (o *RouteGetAlertRuleExportNotFound) Error() string {
	return fmt.Sprintf("[GET /v1/provisioning/alert-rules/{UID}/export][%d] routeGetAlertRuleExportNotFound", 404)
}
