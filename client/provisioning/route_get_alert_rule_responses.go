...
func (o *RouteGetAlertRuleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/provisioning/alert-rules/{UID}] RouteGetAlertRule", response, response.Code())
	}
}
...
func (o *RouteGetAlertRuleOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/provisioning/alert-rules/{UID}][%d] routeGetAlertRuleOk %s", 200, payload)
}
...
func (o *RouteGetAlertRuleNotFound) Error() string {
	return fmt.Sprintf("[GET /v1/provisioning/alert-rules/{UID}][%d] routeGetAlertRuleNotFound", 404)
}
