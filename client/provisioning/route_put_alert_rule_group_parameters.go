...
// WithXDisableProvenance adds the xDisableProvenance to the route put alert rule group params
func (o *RoutePutAlertRuleGroupParams) WithXDisableProvenance(xDisableProvenance *string) *RoutePutAlertRuleGroupParams {
	o.SetXDisableProvenance(xDisableProvenance)
	return o
}

// SetXDisableProvenance adds the xDisableProvenance to the route put alert rule group params
func (o *RoutePutAlertRuleGroupParams) SetXDisableProvenance(xDisableProvenance *string) {
