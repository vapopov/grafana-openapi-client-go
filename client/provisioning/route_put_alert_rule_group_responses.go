...
func (o *RoutePutAlertRuleGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 400:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /v1/provisioning/folder/{FolderUID}/rule-groups/{Group}] RoutePutAlertRuleGroup", response, response.Code())
	}
}
...
func (o *RoutePutAlertRuleGroupOK) Error() string {
	...
	return fmt.Sprintf("[PUT /v1/provisioning/folder/{FolderUID}/rule-groups/{Group}][%d] routePutAlertRuleGroupOk %s", 200, payload)
}
...
func (o *RoutePutAlertRuleGroupBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /v1/provisioning/folder/{FolderUID}/rule-groups/{Group}][%d] routePutAlertRuleGroupBadRequest %s", 400, payload)
}
