...
func (o *RouteGetTemplateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/provisioning/templates/{name}] RouteGetTemplate", response, response.Code())
	}
}
...
func (o *RouteGetTemplateOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/provisioning/templates/{name}][%d] routeGetTemplateOk %s", 200, payload)
}
...
func (o *RouteGetTemplateNotFound) Error() string {
	return fmt.Sprintf("[GET /v1/provisioning/templates/{name}][%d] routeGetTemplateNotFound", 404)
}
