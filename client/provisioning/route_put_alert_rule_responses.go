...
func (o *RoutePutAlertRuleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 400:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /v1/provisioning/alert-rules/{UID}] RoutePutAlertRule", response, response.Code())
	}
}
...
func (o *RoutePutAlertRuleOK) Error() string {
	...
	return fmt.Sprintf("[PUT /v1/provisioning/alert-rules/{UID}][%d] routePutAlertRuleOk %s", 200, payload)
}
...
func (o *RoutePutAlertRuleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /v1/provisioning/alert-rules/{UID}][%d] routePutAlertRuleBadRequest %s", 400, payload)
}
