...
// NewRoutePutPolicyTreeParams creates a new RoutePutPolicyTreeParams object,
...
func NewRoutePutPolicyTreeParams() *RoutePutPolicyTreeParams {
	return &RoutePutPolicyTreeParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewRoutePutPolicyTreeParamsWithTimeout creates a new RoutePutPolicyTreeParams object
...
// NewRoutePutPolicyTreeParamsWithContext creates a new RoutePutPolicyTreeParams object
...
// NewRoutePutPolicyTreeParamsWithHTTPClient creates a new RoutePutPolicyTreeParams object
...
// WithXDisableProvenance adds the xDisableProvenance to the route put policy tree params
func (o *RoutePutPolicyTreeParams) WithXDisableProvenance(xDisableProvenance *string) *RoutePutPolicyTreeParams {
	o.SetXDisableProvenance(xDisableProvenance)
	return o
}

// SetXDisableProvenance adds the xDisableProvenance to the route put policy tree params
func (o *RoutePutPolicyTreeParams) SetXDisableProvenance(xDisableProvenance *string) {
