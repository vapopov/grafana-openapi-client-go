...
// WithXDisableProvenance adds the xDisableProvenance to the route post contactpoints params
func (o *RoutePostContactpointsParams) WithXDisableProvenance(xDisableProvenance *string) *RoutePostContactpointsParams {
	o.SetXDisableProvenance(xDisableProvenance)
	return o
}

// SetXDisableProvenance adds the xDisableProvenance to the route post contactpoints params
func (o *RoutePostContactpointsParams) SetXDisableProvenance(xDisableProvenance *string) {
