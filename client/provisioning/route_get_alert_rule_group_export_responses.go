...
func (o *RouteGetAlertRuleGroupExportReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/provisioning/folder/{FolderUID}/rule-groups/{Group}/export] RouteGetAlertRuleGroupExport", response, response.Code())
	}
}
...
func (o *RouteGetAlertRuleGroupExportOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/provisioning/folder/{FolderUID}/rule-groups/{Group}/export][%d] routeGetAlertRuleGroupExportOk %s", 200, payload)
}
...
func (o *RouteGetAlertRuleGroupExportNotFound) Error() string {
	return fmt.Sprintf("[GET /v1/provisioning/folder/{FolderUID}/rule-groups/{Group}/export][%d] routeGetAlertRuleGroupExportNotFound", 404)
}
