...
func (o *RouteGetPolicyTreeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/provisioning/policies] RouteGetPolicyTree", response, response.Code())
	}
}
...
func (o *RouteGetPolicyTreeOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/provisioning/policies][%d] routeGetPolicyTreeOk %s", 200, payload)
}
