...
// WithXDisableProvenance adds the xDisableProvenance to the route post mute timing params
func (o *RoutePostMuteTimingParams) WithXDisableProvenance(xDisableProvenance *string) *RoutePostMuteTimingParams {
	o.SetXDisableProvenance(xDisableProvenance)
	return o
}

// SetXDisableProvenance adds the xDisableProvenance to the route post mute timing params
func (o *RoutePostMuteTimingParams) SetXDisableProvenance(xDisableProvenance *string) {
